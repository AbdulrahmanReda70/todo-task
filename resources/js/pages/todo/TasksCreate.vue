<template>
    <div class="p-6 max-w-[450px] m-auto">
        <div class="max-w-2xl mx-auto">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                >
                    <p class="font-medium">Error creating task:</p>
                    <p>
                        {{
...
import { useCreateTask } from "../../composables/api/write/useCreateTask";

const router = useRouter();
const { createTask, createTaskLoading, createTaskError } = useCreateTask();
...
const handleSubmit = async () => {
    ...
    try {
        ...
        // The error is already handled by the useCreateTask composable
    }
};
