        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button
                        @click="refreshTasks"
                        :disabled="fetchInProgressTasksLoading"
                    ...
                    >
                        <span
                            v-if="fetchInProgressTasksLoading"
            ...
            <!-- Loading State -->
            <div
                v-if="fetchInProgressTasksLoading && !inProgressTasks.length"
            ...
            >
                <div class="text-center">
                    ...
                    <p class="text-gray-500">Loading in progress tasks...</p>
                </div>
            </div>

            <!-- Error State -->
            <div
                v-else-if="fetchInProgressTasksError"
                class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4"
            >
                <p class="font-medium">Error loading in progress tasks:</p>
                <p>
                    {{
                        fetchInProgressTasksError.message ||
            ...
            <!-- Empty State -->
            <div v-else-if="!inProgressTasks.length" class="text-center py-12">
...
import { useFetchInProgressTasks } from "../../composables/api/read/useFetchInProgressTasks";
...
const handleToggleComplete = async (taskId) => {
    try {
        const task = inProgressTasks.value.find((t) => t.id === taskId);
        if (task) {
            const newStatus =
